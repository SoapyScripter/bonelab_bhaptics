...
namespace MyBhapticsTactsuit
{
    public class TactsuitVR
    {
        ...
        public void GunRecoil(bool isRightHand, float intensity = 1.0f, bool twoHanded = false)
        {
            ...
            if (twoHanded) {scaleOption = new bHapticsLib.ScaleOption(intensity * 0.5f, duration); }
            ...
            if (twoHanded)
            {
                ...
                bHapticsLib.bHapticsManager.PlayRegistered(keyVestOther, keyVestOther, scaleOption, rotationFront);
            }
        }
